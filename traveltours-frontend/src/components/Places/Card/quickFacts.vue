<template>
  <v-container class="px-4 mt-6 pb-0">
    ...
    <H3THighlights class="py-1" :highlights="place.description" v-on="$listeners" />
    <H3TDestinations class="py-1"
      :destinations="place.address_detail + ', ' + place.ward + ', ' + place.district + ', ' + place.province" />
  </v-container>
</template>
