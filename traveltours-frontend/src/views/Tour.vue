<template>
  <div style="max-width: 1200px; margin: auto" class="primary--text">
    <v-row class="mt-4">
      ...
      <v-col cols="12" md="4">
        <H3TTitle class="text-h4">{{ tour.name }}</H3TTitle>
    ...
    <v-container class="mt-6">
      <v-row>
        <v-col cols="12" md="8">
          <div class="text-h4">Tại sao bạn chọn Viet Travel?</div>
          <H3TBookFlexibility />
            ...
            <v-dialog v-model="dialog1" width="500">
              <v-form v-model="valid">
                <v-card>
                  ...
                  <v-rating v-model="rating" background-color="purple lighten-3" color="purple" large />
                  <v-text-field v-model="comment" label="Đánh giá của bạn" :rules="rules" hide-details="auto"
